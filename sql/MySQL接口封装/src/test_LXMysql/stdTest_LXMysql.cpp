...
int main01(int argc, char *argv[])
{
	...
	//5 测试插入数据
	//插入非二进制数据
	XDATA insertData;	//XDATA为std::map<std::string, LXData>数据结构
	//insertData["name"] = "getInsertSqlTest";							//向map数据结构中存值的便捷方式
	insertData.insert(make_pair("name", LXData("getSqlTest")));			//向map数据结构中存值的标准方式
